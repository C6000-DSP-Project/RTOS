...
override PKGDIR = CoreKernel/Platform/C6748
...
package/%.xdc.inc package/%_CoreKernel.Platform.C6748.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package CoreKernel.Platform.C6748" (because $@ is older than $(firstword $?))" ...
...
package/rel/undefinedCoreKernel/Platform/C6748package/package.rel.xml: package/package.cfg.xdc.inc
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	@$(MSG) generating schema include file list ...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js CoreKernel.Platform.C6748 $@
...
.PHONY: release,CoreKernel_Platform_C6748
CoreKernel_Platform_C6748.zip: package/package.bld.xml
CoreKernel_Platform_C6748.zip: package/build.cfg
CoreKernel_Platform_C6748.zip: package/package.xdc.inc
CoreKernel_Platform_C6748.zip: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/CoreKernel_Platform_C6748.zip.dep
endif
package/rel/CoreKernel_Platform_C6748/CoreKernel/Platform/C6748/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

CoreKernel_Platform_C6748.zip: package/rel/CoreKernel_Platform_C6748.xdc.inc package/rel/CoreKernel_Platform_C6748/CoreKernel/Platform/C6748/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELZIP,package/rel/CoreKernel_Platform_C6748.xdc.inc,package/rel/CoreKernel_Platform_C6748.zip.dep)


release release,CoreKernel_Platform_C6748: all CoreKernel_Platform_C6748.zip
clean:: .clean
	-$(RM) CoreKernel_Platform_C6748.zip
	-$(RM) package/rel/CoreKernel_Platform_C6748.xdc.inc
	-$(RM) package/rel/CoreKernel_Platform_C6748.zip.dep
